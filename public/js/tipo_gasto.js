$(document).ready(function () {
    $("#dt_tipo_gasto").DataTable({
        "ajax": "../../negocio/NTipo_Gasto.php?funcion=listado",
        "columns": [
            {"data": "Id"},
            {"data": "Nombre"},
            {"data": "Estado"},
    ...
    $(".insertar").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "../../negocio/NTipo_Gasto.php?funcion=insertar",
            data: {Nombre: Nombre},
    ...
    $(".modificar").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "../../negocio/NTipo_Gasto.php?funcion=modificar",
            data: {
                Id: Id,
                Nombre: Nombre,
            },
    ...
    $(".deshabilitar").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "../../negocio/NTipo_Gasto.php?funcion=deshabilitar",
            data: {Id: Id},
            success: function (data) {
    ...
    $(".habilitar").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "../../negocio/NTipo_Gasto.php?funcion=habilitar",
            data: {Id: Id},
            success: function (data) {
    ...
    /***/
    var table = $('#dt_tipo_gasto').DataTable();
    var tbody = $('#dt_tipo_gasto tbody');
