...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                <h4 class="mt-0 mb-5">Precio</h4>
                <ol class="breadcrumb mb-0">
                    <li><a href="#">Ventas</a></li>
                    <li><a href="#">Precio</a></li>
                    <li class="active">Listado de Precio</li>
                </ol>
            </div>
        </div>
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de Precio</h3>
                    <div class="pull-right">
                        <a href="crear_precio.php" class="btn btn-primary"><i class="ti-plus"></i> Crear Precio</a>
                    </div>
                </div>
                <div class="widget-body">
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    ...
                                    <h4 class="modal-title">Deshabilitar Precio</h4>
                                </div>
                                <div class="modal-body">
                                    <input id="Id_deshabilitar" type="hidden" class="form-control">
                                    <p>Deshabilitar el Precio seleccionada</p>
                                </div>
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                                aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Habilitar Precio</h4>
                                </div>
                                <div class="modal-body">
                                    <input id="Id_habilitar" type="hidden" class="form-control">
                                    <p>Habilitar el Precio seleccionada</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-raised btn-default">
                                        Cancelar
                    ...
                    <table id="dt_precio" cellspacing="0" width="100%"
