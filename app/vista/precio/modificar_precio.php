...
<!-- Header start-->
<header>
    <a href="index_precio.php" class="brand pull-left">
...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                <h4 class="mt-0 mb-5">Precios</h4>
                <ol class="breadcrumb mb-0">
                    <li><a href="#">Ventas</a></li>
                    <li><a href="#">Precios</a></li>
                    <li><a href="index_precio.php">Listado de Precio</a></li>
                    <li class="active">Modificar Precio</li>
                </ol>
            </div>
        </div>
        <div class="page-content container-fluid">
                    ...
                    <div class="widget">
                        <div class="widget-heading">
                            <h3 class="widget-title">Modificar Precio</h3>
                        </div>
								...
								<div class="row">	
									<div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input id="Id"  value="<?php echo $Id ?>" type="text" name="Id" data-rule-required="true"
								...
								<div class="row">
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input id="Monto_m" value="<?php echo $Monto ?>" type="text" name="Monto_m" class="form-control">
										</div>
									</div>
                                </div>
                            </form>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBTrRrR9m4UMmGaE53DzLnJvFJpKMTuu84&libraries=places&language=es&callback=initialize"
        async defer></script>
...
<script type="text/javascript" src="../../../public/js/precio.js"></script>
