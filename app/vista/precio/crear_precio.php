...
require '../../negocio/NGrupo_Tienda.php';
require '../../negocio/NProducto.php';
        ...
        <div class="page-header clearfix">
            <div class="pull-left">
                ...
                <ol class="breadcrumb mb-0">
                    <li><a href="#">Grupo_Tienda</a></li>
                    <li><a href="#">Precio</a></li>
                    <li><a href="index_precio.php">Listado de Precio</a></li>
                    <li class="active">Crear Precio</li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="widget">
                        <div class="widget-heading">
                            <h3 class="widget-title">Crear Precio</h3>
                        </div>
