...
require '../../negocio/NDetalle_Venta.php';
$insumo = new DInsumo();
...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                <h4 class="mt-0 mb-5">Ventas</h4>
                <ol class="breadcrumb mb-0">
                    <li><a href="#">Ventas</a></li>
                    <li><a href="#">Ventas</a></li>
                    <li><a href="index_reporte_venta.php">Listado de Ventas</a></li>
        ...
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-body">
                    <div class="row">
                        <input id="id_venta" name="id_venta" hidden value="<?php echo $id_venta ?>">
                        <input id="id_usuario" name="id_usuario" hidden value="<?php echo $id_usuario ?>">
                        <input id="Codigo_Control" name="Codigo_Control" hidden value="<?php echo $Codigo_Control ?>">
                        <div class="col-sm-4">
                            <address>
                                <strong>Id </strong><?php echo $id_venta ?><br>
                                <strong>Fecha </strong><?php echo $fecha ?><br>
                                <strong>Tienda </strong><?php echo $nombre_tienda ?><br>
								<strong>Usuario </strong><?php echo $nombre_usuario ?><br>
                                ...
                                if ($estado == 0) {
                                    ...
                                    <div class="button-container">
                                        <button class="btn btn-raised btn-black pull-right Pagar_Venta">Pagar Venta</button>
                                        <button class="btn btn-raised btn-black pull-right Anular_Venta">Anular Venta</button>
                                    </div>
                                    <?php
                                } else if ($estado == 1) {
                                    echo 'Cancelado';
...
<script type="text/javascript" src="../../../public/js/reporte_venta_show.js"></script>
