...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                <h4 class="mt-0 mb-5">Órdenes de producción</h4>
                <ol class="breadcrumb mb-0">
                    <li><a href="#">producción</a></li>
                    <li><a href="#">Órdenes de producción</a></li>
                    <li class="active">Listado de órdenes de producción</li>
                </ol>
            </div>
        </div>
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de órdenes de producción</h3>
                    <div class="pull-right">
                        <a class="btn btn-primary" href="crear_produccion.php"><i class="ti-plus"></i> Crear órden de producción
                        </a>
                    </div>
                </div>
                <div class="widget-body">
                    ...
                    <div tabindex="-1" role="dialog"
                         class="modal fade bs-modal-form-confirmar text-left">
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                                aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Confirmar cantidad orden de producción</h4>
                                </div>
                                <div class="modal-body">
                                    <form>
                                        <p class="pl-10 pr-10 pt-5 pb-5 bg-demo">Fecha Orden de Producción: <label
                                                    id="fecha"></label>
                                            <br>Receta: <label id="receta"></label>
                                            <br>Producto: <label id="producto"></label>
                                        </p>
                                        <input id="id_orden_produccion" type="hidden" name="id_orden_produccion">
                                        <p>Confirmar la cantidad en la orden de producción seleccionada</p>
                                        <div class="form-group">
                                            <label for="cantidad_produccion">Cantidad Producción</label>
                                            <input id="cantidad_produccion" type="number" min="1" class="form-control">
                                        </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-raised btn-black confirmar-cantidad">
                                        Confirmar
                                    </button>
                                </div>
                    ...
                    <table id="dt_produccion" cellspacing="0" width="100%"
