...
<!-- Header start-->
<header>
    <a href="index_tipo_gasto.php" class="brand pull-left">
...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                <h4 class="mt-0 mb-5">Tipo de Gastos</h4>
                <ol class="breadcrumb mb-0">
                    <li><a href="#">Configuración</a></li>
                    <li><a href="#">Tipo de Gastos</a></li>
                    <li class="active">Listado de Tipo de Gastos</li>
                </ol>
            </div>
        </div>
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de Tipo de Gastos</h3>
                    <div class="pull-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target=".bs-modal-form-insertar"><i class="ti-plus"></i> Crear Tipo de Gastos
                        </button>
                    </div>
                </div>
                <div class="widget-body">
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Crear Tipo de Gastos</h4>
                                </div>
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                                aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Modificar Tipo de Gastos</h4>
                                </div>
                                <div class="modal-body">
                                    <form method="post">
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                                aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Deshabilitar Tipo de Gastos</h4>
                                </div>
                                <div class="modal-body">
                                    <input id="Id_deshabilitar" type="hidden" class="form-control">
                                    <p>Deshabilitar el Tipo de Gastos seleccionada</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-raised btn-default">
                                        Cancelar
                    ...
                    <table id="dt_tipo_gasto" cellspacing="0" width="100%"
...
<script type="text/javascript" src="../../../public/js/tipo_gasto.js"></script>
