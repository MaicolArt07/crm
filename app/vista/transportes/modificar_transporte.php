        ...
        <div class="page-content container-fluid">
            <div class="widget">
				...
				<div class="row">
					...
					<div class="row">
                            <div class="col-md-12">
                                <table id="dt_detalle_ant" class="table nowrap table-bordered table-condensed">
                                    <thead>
                                    <tr>
                                        <th>Id Detalle Transporte</th>
                                        <th>Id</th>
                                        <th>Producto</th>
                    ...
                    <form id="form-trasnporte" method="post" novalidate="novalidate">
							...
							<div class="widget-heading clearfix">
								<h4 class="widget-title pull-left">Adicionar Productos</h3>
							</div>
						</div>					
						<div class="row">
                            <div class="col-md-4">
...
<script type="text/javascript" src="../../../public/js/transporte_modificar.js"></script>
