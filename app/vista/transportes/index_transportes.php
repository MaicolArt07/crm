...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                <h4 class="mt-0 mb-5">Órdenes de transporte</h4>
                <ol class="breadcrumb mb-0">
                    <li><a href="#">Transportar</a></li>
                    <li><a href="#">Órdenes de transporte</a></li>
                    <li class="active">Listado de órdenes de transporte</li>
                </ol>
            </div>
        </div>
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de órdenes de transporte</h3>
                    <div class="pull-right">
                        <a href="crear_transporte.php" class="btn btn-primary"><i class="ti-plus"></i> Crear órden de
                            transporte</a>
                    </div>
                </div>
                <div class="widget-body">
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    ...
                                    <h4 class="modal-title">Finalizar órden de transporte</h4>
                                </div>
                                <div class="modal-body">
                                    <input id="id_compra" type="hidden" class="form-control">
                                    <p>Desea finalizar la órden de transporte para éste producto?</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-raised btn-default">
                                        Cancelar
                                    </button>
                                    <button type="button" class="btn btn-raised btn-black cancelar-total">Finalizar
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <table id="dt_transportes" cellspacing="0" width="100%"
