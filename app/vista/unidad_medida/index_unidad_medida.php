...
<!-- Header start-->
<header>
    <a href="index_unidad_medida.php" class="brand pull-left">
...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                <h4 class="mt-0 mb-5">Unidad de medida</h4>
        ...
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de unidades de medida</h3>
                    <div class="pull-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target=".bs-modal-form-insertar"><i class="ti-plus"></i> Crear unidad de medida
                        </button>
                    </div>
                </div>
                <div class="widget-body">
                    ...
                    <div tabindex="-1" role="dialog"
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post">
                                        <input id="id_unidad_medida" type="hidden" class="form-control">
                                        <div class="form-group">
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                                aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Deshabilitar unidad de medida</h4>
                                </div>
                                <div class="modal-body">
                                    <input id="Id_deshabilitar" type="hidden" class="form-control">
                                    <p>Deshabilitar la unidad de medida seleccionada</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-raised btn-default">
                                        Cancelar
                    ...
                    <div tabindex="-1" role="dialog"
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input id="id_unidad_medida_habilitar" type="hidden" class="form-control">
                    ...
                    <table id="dt_unidades" cellspacing="0" width="100%"
...
<script type="text/javascript" src="../../../public/js/unidad_medida.js"></script>
