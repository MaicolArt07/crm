        ...
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-body">
                    <div class="row">
                        <input id="id_pago" name="id_pago" hidden value="<?php echo $id_pago ?>">
                        <div class="col-sm-4">
                            <address>
                                <strong>Fecha </strong><?php echo $fecha ?><br>
                                <strong>Cliente </strong><?php echo $cliente ?><br>
                                <strong>Método de Pago </strong><?php echo $Metodo_Pago ?><br>
                                <strong>Codigo de Método de Pago </strong><?php echo $Codigo_Metodo_Pago ?><br>
                                <strong>Total </strong><?php echo $total ?> Bs.<br>
                                <strong>Estado </strong><?php if ($estado == 1) echo 'Valido'; else echo 'Anulado' ?>
                                <br>
                            </address>
                        </div>
                    </div>
                    <div class="table-responsive">
                    <table id="dt_detalle_pago" class="table nowrap table-bordered table-condensed">
                        <thead>
                        <tr>
                            <th>Venta</th>
                            <th>Tienda</th>
...
<script type="text/javascript" src="../../../public/js/pago_show.js"></script>
