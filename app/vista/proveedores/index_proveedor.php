...
<!-- Header start-->
<header>
    <a href="index_proveedor.php" class="brand pull-left">
...
<div class="main-container">
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                <h4 class="mt-0 mb-5">Proveedores</h4>
        ...
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de proveedores</h3>
                    <div class="pull-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target=".bs-modal-form-insertar"><i class="ti-plus"></i> Crear proveedor
                        </button>
                    </div>
                </div>
                <div class="widget-body">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post">
                                        ...
                                        <input id="id_proveedor" readonly class="form-control">
                                        <div class="form-group">
                                            <label for="nombre_modificar">Nombre</label>
                                            <input id="nombre_modificar" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="nit_modificar">NIT</label>
                                            <input id="nit_modificar" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="direccion_modificar">Dirección</label>
                                            <input id="direccion_modificar" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="telefono_modificar">Teléfono</label>
                                            <input id="telefono_modificar" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="correo_modificar">Correo electrónico</label>
                                            <input id="correo_modificar" type="text" class="form-control">
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
                    ...
                    <div tabindex="-1" role="dialog"
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
									<label for="id">Id</label>
                                    <input id="id_proveedor_deshabilitar" readonly class="form-control">
									<label for="nombre">Nombre</label>
                                    <input id="nombre_proveedor_deshabilitar" readonly class="form-control">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-raised btn-default">
                                        Cancelar
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                                aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Habilitar Proveedor</h4>
                                </div>
                                <div class="modal-body">
									<label for="id">Id</label>
                                    <input id="id_proveedor_habilitar" readonly class="form-control">
									<label for="nombre">Nombre</label>
                                    <input id="nombre_proveedor_habilitar" readonly class="form-control">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-raised btn-default">
                                        Cancelar
                    ...
                    <table id="dt_proveedores" cellspacing="0" width="100%"
