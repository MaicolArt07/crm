        ...
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de recetas</h3>
                    <div class="pull-right">
                        <a href="crear_receta.php" class="btn btn-primary"><i class="ti-plus"></i> Crear receta</a>
                    </div>
                </div>
                <div class="widget-body">
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    ...
                                    <h4 class="modal-title">Deshabilitar Receta</h4>
                                </div>
                                <div class="modal-body">
									<label for="id">Id</label>
                                    <input id="id_receta_deshabilitar" readonly class="form-control">
									<label for="id">Nombre</label>
                                    <input id="nombre_receta_deshabilitar" readonly class="form-control">
                                </div>
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                                aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Habilitar Receta</h4>
                                </div>
                                <div class="modal-body">
									<label for="id">Id</label>
                                    <input id="id_receta_habilitar" readonly class="form-control">
									<label for="id">Nombre</label>
                                    <input id="nombre_receta_habilitar" readonly class="form-control">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-raised btn-default">
                                        Cancelar
                    ...
                    <table id="dt_recetas" cellspacing="0" width="100%"
...
<script type="text/javascript" src="../../../public/js/receta.js"></script>
