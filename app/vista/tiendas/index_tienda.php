        ...
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de tiendas</h3>
                    <div class="pull-right">
                        <a href="crear_tienda.php" class="btn btn-primary"><i class="ti-plus"></i> Crear tienda</a>
                    </div>
                </div>
                <div class="widget-body">
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    ...
                                    <h4 class="modal-title">Deshabilitar tienda</h4>
                                </div>
                                <div class="modal-body">
                                    <input id="id_tienda_deshabilitar" type="hidden" class="form-control">
                                    <p>Deshabilitar la tienda seleccionada</p>
                                </div>
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-black">
                                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                                aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Habilitar tienda</h4>
                                </div>
                                <div class="modal-body">
                                    <input id="id_tienda_habilitar" type="hidden" class="form-control">
                                    <p>Habilitar la tienda seleccionada</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-raised btn-default">
                                        Cancelar
                    ...
                    <table id="dt_tiendas" cellspacing="0" width="100%"
