                ...
                <div class="col-lg-6 col-md-12">
                    <div class="widget">
                        <div class="widget-heading">
                            <h3 class="widget-title">Crear tienda</h3>
                        </div>
                              ...
                              <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input id="razon_social" type="text" name="razon_social" data-rule-required="true"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="nit" type="text" name="nit" data-rule-required="true"
                                                   minlength="0"
                                                   class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="contacto">Contacto/Correo</label>
                                            <input id="contacto" type="text" minlength="0"class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
