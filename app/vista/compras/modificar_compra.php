                                ...
                                <div class="form-group">
                                    ...
                                    <div data-format="dd/mm/yyyy" class="input-group">
                                        <input id="fecha" type="text" name="fecha"
                                               data-rule-required="true" value="<?php echo $fecha ?>"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <div class="radio-custom radio-inline">
                                            <input id="cancelado" type="radio" name="estado" value="0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="total" type="text" name="total" readonly value="<?php echo $total ?>"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="id_detalle_compra" name="id_detalle_compra" hidden>
...
<script type="text/javascript" src="../../../public/js/compra_modificar.js"></script>
