        ...
        <div class="page-content container-fluid">
            <div class="widget">
                <div class="widget-heading clearfix">
                    <h3 class="widget-title pull-left">Listado de compras</h3>
                    <div class="pull-right">
                        <a href="crear_compra.php" class="btn btn-primary"><i class="ti-plus"></i> Crear compra</a>
                    </div>
                </div>
                <div class="widget-body">
                        ...
                        <div role="document" class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p>Desea cancelar el pago pendiente de la compra?</p>
                                </div>
                    ...
                    <table id="dt_compras" cellspacing="0" width="100%"
